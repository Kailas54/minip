"""
Django settings for platevision project.
...
SECRET_KEY = 'django-insecure-ew#974qjdxo9pjr(np0hvtj^%b#0@aknk%#r6obp*!1a^xza8+'
...
ASGI_APPLICATION = 'mini.asgi.application'
